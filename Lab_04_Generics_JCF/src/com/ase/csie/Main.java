...
public class Main {
	...
	public static void change(SingleRoom sr) {
		sr.setRoomNumber(1);
	}

	public static void main(String[] args) {
		
//		SingleRoom sr = new SingleRoom(3, "East", new Amenity[] {Amenity.TV}, 12);
...
//		Map<Booking, HotelRoom> map = new Hashtable<Booking, HotelRoom>();
